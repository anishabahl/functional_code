...
newname = 'visbandresponses.csv'
parameternewname = 'visidealbandparameters.csv'
parameter2name = 'visidealbandparameterssecondpeak.csv'
filter1name = 'vislongpass_filter.csv'
filter2name = 'visshortpass_filter.csv'
wavelengthname = 'visfullxaxis16.csv'
######IMPORT DATA
...
Array6 = pd.DataFrame(array6)
Array6.to_csv(newlocation+wavelengthname, index=False)
